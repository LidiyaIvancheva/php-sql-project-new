...
(1, 'Salon of the Arts Sofia: An Enchanting Patchwork of Genres', 'The International Festival Salon of the Arts Sofia takes place every year in the National Palace of Culture. The event serves as a creative forum for different forms of arts, such as music, theatre, cinema, dance etc.', 'bul Stamboliiski 5, Sofia, Bulgaria', 240, 20, '2016-04-20', 5, NULL),
(2, 'LIFTBalkans', 'LiftBalkans is a timely support of the industry in South-East Europe with aim to speed up the well-needed modernization of the stock of old lifts in the Region by presenting the latest products and services. ', 'Expro Center, Sofia, Bulgaria', 500, 25, '2016-04-30', 3, NULL),
(3, 'Get Traction: The Virtual Growth Event [SOFIA] in Sofia', 'There’s no denying that growth is hot and here to stay. But despite the buzz, many businesses still don’t have the framework they need to build a successful growth engine.', '147, Tzarigradsko shosse, Sofia, Bulgaria', 800, 15, '2016-04-06', 3, NULL),
(4, 'Smart Cities', 'Smart Cities is the only specialized event in Bulgaria in a format ‘exhibition – conference’. It aims to promote modern technologies and good practices that can transform our cities into more environmentally friendly and efficient systems.', 'Inter Expo Center, Sofia, Bulgaria', 200, 10, '2016-06-04', 3, NULL),
(5, 'International Conference On Recent Advances In Engineering And Technology', 'The International Conference On Recent Advances In Engineering And Technology, organized by the International Academic of Science, Technology\n', 'Mühlenstraße\r\n10243, Berlin, Germany', 300, 20, '2016-06-09', 4, NULL),
(6, 'Rihanna in Warsaw', 'GLOBAL SUPERSTAR RIHANNA - THE ANTI WORLD TOUR', ' aleja Poniatowskiego 1, 03-901 Warszawa Warsaw, Poland ', 20000, 100, '2016-08-05', 1, NULL),
(7, 'gfh5', 'new', '', 2016, 30, '2016-08-20', 4, '2016-05-03');
