...
//edit the event date
	...
	echo "<form action='update.php' method='post'>";
	echo "<input type='hidden' name='event_id' value=".$row['event_id'].">";
	echo "<input type='text' name='event_name' value='".$row['event_date']."'>";
	echo "<input type='submit' name='submit' value='update'>";
	echo "</form>";
	echo "<br>";
}else {
	...
	$update_query = "UPDATE events 
					...
					$event_id = $_POST['event_id'];
	$tickets_price = $_POST['ticket_price'];
	$update_query = "UPDATE events 
	...
	if ($update_result) {
		...
		echo "You sucessfully updated the $event_name in the DB!";
		echo "<p><a href='read.php'>Read DB</a></p>";
		echo "You sucessfully updated the $ticket_price in the DB!";
		echo "<p><a href='read.php'>Read DB</a></p>";
		echo "You sucessfully updated the $event_date in the DB!";
		echo "<p><a href='read.php'>Read DB</a></p>";
		echo "You sucessfully updated the $seats in the DB!";
		echo "<p><a href='read.php'>Read DB</a></p>";
	}else{
		echo "you wre not able to update the data! Please try again!";
